...
class Track(Base):
    ...
    daily_plays = relationship('DailyPlay', back_populates='track', cascade='all, delete-orphan')
...
class Snapshot(Base):
    ...
    # Relationships
    play_history = relationship('PlayHistory', back_populates='snapshot', cascade='all, delete-orphan')
...
class PlayHistory(Base):
    ...
    persistent_id = Column(String(16), ForeignKey('tracks.persistent_id'), nullable=False)
...
class DailyPlay(Base):
    ...
    persistent_id = Column(String(16), ForeignKey('tracks.persistent_id'), primary_key=True)
